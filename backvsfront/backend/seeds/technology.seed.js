//Configuramos la conexion a la BD de MongoDB para insertar los technologies
...
//El siguiente metodo nos devuelve una promesa
Technology.create(technologies)
.then( ()=>{
  console.log("Technologies created");
  mongoose.disconnect();
})
.catch( console.log("Error: Database is not connect.") );